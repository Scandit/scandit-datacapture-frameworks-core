...
public class CoreModuleCommandFactory {
    ...
    public static func create(module: CoreModule, _ method: FrameworksMethodCall) -> CoreModuleCommand? {
        ...
        case "isMacroModeAvailable":
            return IsMacroModeAvailableCommand(module: module)
        ...
        case "unregisterTorchStateListener":
            return UnregisterTorchStateListenerCommand(module: module)
        case "registerZoomLevelListener":
            return RegisterZoomLevelListenerCommand(module: module)
        case "unregisterZoomLevelListener":
            return UnregisterZoomLevelListenerCommand(module: module)
        case "selectZoomLevel":
            return SelectZoomLevelCommand(module: module, method)
        case "registerMacroModeListener":
            return RegisterMacroModeListenerCommand(module: module)
        case "unregisterMacroModeListener":
            return UnregisterMacroModeListenerCommand(module: module)
        ...
        case "registerFocusGestureListener":
            return RegisterFocusGestureListenerCommand(module: module, method)
        case "unregisterFocusGestureListener":
            return UnregisterFocusGestureListenerCommand(module: module, method)
        case "triggerFocus":
            return TriggerFocusCommand(module: module, method)
        case "triggerZoomIn":
            return TriggerZoomInCommand(module: module, method)
        case "triggerZoomOut":
            return TriggerZoomOutCommand(module: module, method)
        case "registerZoomGestureListener":
            return RegisterZoomGestureListenerCommand(module: module, method)
        case "unregisterZoomGestureListener":
            return UnregisterZoomGestureListenerCommand(module: module, method)
