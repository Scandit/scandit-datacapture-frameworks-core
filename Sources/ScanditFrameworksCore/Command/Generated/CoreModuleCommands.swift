...
public class IsMacroModeAvailableCommand: CoreModuleCommand {
    private let module: CoreModule
...
public class RegisterTorchStateListenerCommand: CoreModuleCommand {
    ...
    public func execute(result: FrameworksResult) {
        ...
        module.registerTorchStateListener(
            result: result
        )
    }
}
/// Unregisters the torch state event listener
public class UnregisterTorchStateListenerCommand: CoreModuleCommand {
    private let module: CoreModule
    public init(module: CoreModule) {
        self.module = module
    }
    ...
    public func execute(result: FrameworksResult) {
        ...
        module.unregisterTorchStateListener(
            result: result
        )
    }
}
/// Registers a persistent listener for zoom level change events
public class RegisterZoomLevelListenerCommand: CoreModuleCommand {
    private let module: CoreModule
    public init(module: CoreModule) {
        self.module = module
    }
    ...
    public func execute(result: FrameworksResult) {
        // Register/unregister event callbacks
        result.registerCallbackForEvents([
            "ZoomListener.onZoomLevelChanged"
        ])
        module.registerZoomLevelListener(
            result: result
        )
    }
}
/// Unregisters the zoom level event listener
public class UnregisterZoomLevelListenerCommand: CoreModuleCommand {
    private let module: CoreModule
    public init(module: CoreModule) {
        self.module = module
    }
    ...
    public func execute(result: FrameworksResult) {
        ...
        module.unregisterZoomLevelListener(
            result: result
        )
    }
}
/// Selects the zoom level on the ZoomSwitchControl. Returns the actual zoom level applied.
public class SelectZoomLevelCommand: CoreModuleCommand {
    private let module: CoreModule
    ...
    public init(module: CoreModule, _ method: FrameworksMethodCall) {
        ...
        self.zoomLevel = method.argument(key: "zoomLevel") ?? Double()
    }

    public func execute(result: FrameworksResult) {
        module.selectZoomLevel(
            viewId: viewId,
            zoomLevel: zoomLevel,
            result: result
        )
...
public class RegisterMacroModeListenerCommand: CoreModuleCommand {
    private let module: CoreModule
    public init(module: CoreModule) {
        self.module = module
    }
    ...
    public func execute(result: FrameworksResult) {
        // Register/unregister event callbacks
        result.registerCallbackForEvents([
            "MacroModeListener.onMacroModeChanged"
        ])
        module.registerMacroModeListener(
            result: result
        )
    }
}
/// Unregisters the macro mode event listener
public class UnregisterMacroModeListenerCommand: CoreModuleCommand {
    private let module: CoreModule
    public init(module: CoreModule) {
        self.module = module
    }
    ...
    public func execute(result: FrameworksResult) {
        ...
        module.unregisterMacroModeListener(
            result: result
        )
    }
}
...
public class RegisterFocusGestureListenerCommand: CoreModuleCommand {
    private let module: CoreModule
    private let viewId: Int
    public init(module: CoreModule, _ method: FrameworksMethodCall) {
        self.module = module
    ...
    public func execute(result: FrameworksResult) {
        ...
        result.registerViewSpecificCallback(
            viewId,
            eventNames: [
                "FocusGestureListener.onFocusGesture"
            ]
        )
        module.registerFocusGestureListener(
            viewId: viewId,
            result: result
        )
    }
...
public class UnregisterFocusGestureListenerCommand: CoreModuleCommand {
    private let module: CoreModule
    private let viewId: Int
    public init(module: CoreModule, _ method: FrameworksMethodCall) {
        self.module = module
    ...
    public func execute(result: FrameworksResult) {
        ...
        module.unregisterFocusGestureListener(
            viewId: viewId,
            result: result
        )
    }
...
public class TriggerFocusCommand: CoreModuleCommand {
    private let module: CoreModule
    private let viewId: Int
    private let pointJson: String
    public init(module: CoreModule, _ method: FrameworksMethodCall) {
...
public class TriggerZoomInCommand: CoreModuleCommand {
    private let module: CoreModule
    private let viewId: Int
    public init(module: CoreModule, _ method: FrameworksMethodCall) {
        self.module = module
...
public class TriggerZoomOutCommand: CoreModuleCommand {
    private let module: CoreModule
    private let viewId: Int
    public init(module: CoreModule, _ method: FrameworksMethodCall) {
        self.module = module
...
public class RegisterZoomGestureListenerCommand: CoreModuleCommand {
    private let module: CoreModule
    private let viewId: Int
    public init(module: CoreModule, _ method: FrameworksMethodCall) {
        self.module = module
    ...
    public func execute(result: FrameworksResult) {
        ...
        result.registerViewSpecificCallback(
            viewId,
            eventNames: [
                "ZoomGestureListener.onZoomInGesture",
                "ZoomGestureListener.onZoomOutGesture",
            ]
        )
        module.registerZoomGestureListener(
            viewId: viewId,
            result: result
        )
    }
...
public class UnregisterZoomGestureListenerCommand: CoreModuleCommand {
    private let module: CoreModule
    private let viewId: Int
    public init(module: CoreModule, _ method: FrameworksMethodCall) {
        self.module = module
    ...
    public func execute(result: FrameworksResult) {
        ...
        module.unregisterZoomGestureListener(
            viewId: viewId,
            result: result
        )
    }
